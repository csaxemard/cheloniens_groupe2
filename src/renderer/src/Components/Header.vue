<script setup lang="ts">
    ...
    const loginBoxTab = ref<"loginform" | "signinForm">("signinForm")
    ...
    <div class="Header">
        <header :class="{ headerIsHidden: headerIsHidden }">
            ...
            <Transition name="slideOut">
                <div v-if="isLoginBoxShown" class="loginBox">
                    <div class="tabs">
                        <button :class="loginBoxTab != 'loginform' ? 'isCurrentTab' : ''"
                            @click="loginBoxTab = 'signinForm'">Inscription</button>
                        <hr>
                        <button :class="loginBoxTab == 'loginform' ? 'isCurrentTab' : ''"
                            @click="loginBoxTab = 'loginform'">Connexion</button>
                    </div>
                    <form v-if="loginBoxTab == 'signinForm'" @submit.prevent="() => submitProfileForm('signin')">
                    ...
                    <form v-if="loginBoxTab == 'loginform'" @submit.prevent="() => submitProfileForm('login')">
